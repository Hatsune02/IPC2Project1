...
<body>
<div class="container">
    <h1>TRANSPORTES PARA USUARIOS</h1>
    <hr>
    <div class="navbar">
        <form class="">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-warning" href="CarrierController?menu=transportsU&action=onTheWay&transportId=<%= transport.getId()%>">EN CAMINO</a>
