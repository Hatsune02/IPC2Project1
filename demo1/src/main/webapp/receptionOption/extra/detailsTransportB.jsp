...
<div class="container">
    ...
    <div class="">
        <table class="table table-hover">
            ...
            <%
                ...
                if(list!=null){
                    ...
                    for(DetailsTransport detailsTransport:list){ id = detailsTransport.getTransportBetweenLibrary();
            %>
            <tr>
        ...
        <a class="btn btn-success" href="ReceptionController?menu=transportB&action=back&transportId=<%=id%>">Regresar</a>
    </div>
</div>
