...
<body>
<div class="container">
    <h1>SOLICITU DE PRÉSTAMO: LIBROS</h1>
    <hr>
    <div class="navbar">
        <form class="">
        </form>
        <form class="form-inline" method="post" action="FinalUserController?menu=loanApplication">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-success" href="FinalUserController?menu=loanApplication&action=select&libId=<%= bookLib.getLibraryID()%>&isbn=<%= bookLib.getBookIsbn()%>">Seleccionar</a>
                </td>
                <%}}%>
            </tr>
