...
<div class="container">
    ...
    <div class="navbar">
        ...
        <form class="form-inline" method="post" action="FinalUserController?menu=books">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-success" href="FinalUserController?menu=books&action=details&libId=<%= bookLib.getLibraryID()%>&isbn=<%= bookLib.getBookIsbn()%>">Detalles</a>
                </td>
                <%}}%>
            </tr>
