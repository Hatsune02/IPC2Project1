...
<div class="container">
    ...
    <div class="navbar">
        ...
        <form class="form-inline" method="post" action="FinalUserController?menu=loans">
    ...
    <div class="">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="text-center"><%=loan.getReceptionist()%></td>
                <td class="text-center"><%=loan.getBookIsbn()%></td>
                <td class="text-center"><%=loan.getBook()%></td>
                <td class="text-center">
                    <a class="btn btn-success" href="FinalUserController?menu=loans&action=select&loanId=<%=loan.getId()%>">Seleccionar</a>
                </td>
                <%}}%>
            </tr>
