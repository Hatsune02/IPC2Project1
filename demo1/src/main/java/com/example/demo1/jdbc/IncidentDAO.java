...
public class IncidentDAO {
    ...
    private static final String SQL_INSERT1 = "insert into incidents(id,loan, incident_type, amount_paid) value(?,?,?,?)";
    ...
    public int insertId(Incident incident){
        Connection con = null;
        PreparedStatement ps = null;
        int records = 0;
        try {
            ...
            ps.setInt(2,incident.getLoanId());
            ps.setString(3,incident.getIncidentType());
            ps.setDouble(4,incident.getAmountPaid());
            records = ps.executeUpdate();
